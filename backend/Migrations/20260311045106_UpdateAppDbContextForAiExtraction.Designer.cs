...
namespace CanonGuard.Api.Migrations
{
    ...
    [Migration("20260311045106_UpdateAppDbContextForAiExtraction")]
    partial class UpdateAppDbContextForAiExtraction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CanonGuard.Api.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("CanonGuard.Api.Models.Chapter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CanonGuard.Api.Models.Fact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CanonGuard.Api.Models.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CanonGuard.Api.Models.Project", b =>
                {
                    b.HasOne("CanonGuard.Api.Models.AppUser", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CanonGuard.Api.Models.AppUser", null)
                        .WithMany()
